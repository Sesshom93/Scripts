...
import MasterFarmer.Tasks.Bank;
import MasterFarmer.Tasks.Drop;
import MasterFarmer.Tasks.Heal;
import MasterFarmer.Tasks.Pick;
import Minnows.MyConstants;
...
public class Pickpocket extends PollingScript<ClientContext> implements PaintListener {
    ...
    public void repaint(Graphics graphics) {
        ...
        g.setColor(new Color(255, 255, 255, 250));
        g.drawString(" in inventory: " + Pick.ranarrInventory, 69, 740);
        g.setColor(new Color(50, 205, 50, 250));
        g.drawString("Snapdragons ", 14, 755);
        g.setColor(new Color(255, 255, 255, 250));
        g.drawString(" in inventory: " + Pick.snapdragonInventory, 106, 755);
        ...
        g.drawString("- Cakes ", 215, 740);
        g.setColor(new Color(255, 255, 255, 250));
        g.drawString("in inventory: " + Bank.cakeInventory, 271, 740);
        g.setColor(new Color(255, 255, 0, 250));
        g.drawString("- Necklaces ", 215, 755);
        g.setColor(new Color(255, 255, 255, 250));
        g.drawString("in inventory: " + Bank.necklaceInventory, 301, 755);
        g.drawString("- Cakes in bank: " + Bank.cakeBank, 215, 770);
