...
public class Constants {
    ...
    public static final int DAZED = 424;
    public static final int GUARD_ATTACKING = 401;

    //Npc ID's
    public static final int MASTER_FARMER = 3257;
    public static final int GUARD = 3259;

    //Item ID's
    public static final int CAKE = 1891;
    public static final int CAKE2 = 1893;
    public static final int CAKE3 = 1895;
    ...
    //Path ID's
    public static final Tile[] PATH_TO_BANK = {new Tile(3077, 3250, 0), new Tile(3080, 3250, 0), new Tile(3083, 3250, 0), new Tile(3087, 3250, 0), new Tile(3090, 3249, 0), new Tile(3092, 3246, 0), new Tile(3092, 3243, 0)};
}
